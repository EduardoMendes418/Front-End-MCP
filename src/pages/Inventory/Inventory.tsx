          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                ...
                <th className="text-left py-3 px-4 text-sm font-medium text-gray-600 dark:text-gray-400">Categoria</th>
                <th className="text-left py-3 px-4 text-sm font-medium text-gray-600 dark:text-gray-400">Preço</th>
                <th className="text-left py-3 px-4 text-sm font-medium text-gray-600 dark:text-gray-400">Estoque</th>
                <th className="text-left py-3 px-4 text-sm font-medium text-gray-600 dark:text-gray-400">Status</th>
                <th className="text-left py-3 px-4 text-sm font-medium text-gray-600 dark:text-gray-400">Ações</th>
              </tr>
            </thead>
            <tbody>
              {filteredProducts.map((product) => (
                <tr key={product.id} className="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-750">
                  ...
                  <td className="py-3 px-4 text-sm text-gray-900 dark:text-white">{product.category}</td>
                  <td className="py-3 px-4 text-sm text-gray-900 dark:text-white">R$ {product.price.toLocaleString()}</td>
                  <td className="py-3 px-4 text-sm text-gray-900 dark:text-white">{product.stock} unidades</td>
                  <td className="py-3 px-4">
                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                      ...
                      {product.stock > 20 ? 'Disponível' : product.stock > 5 ? 'Baixo' : 'Crítico'}
                    </span>
                  </td>
                  <td className="py-3 px-4">
